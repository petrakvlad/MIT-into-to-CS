...
class PhraseTrigger(Trigger):
    ...
    def is_phrase_in(self, story):
        ...
        no_punct_text = ''.join(ch if ch not in string.punctuation else ' ' for ch in story.upper())
...
class BeforeTrigger(TimeTrigger):
    ...
    def evaluate(self, story):
        ...
        story_time = story_time.replace(tzinfo=pytz.utc)
...
class AndTrigger(Trigger):
    ...
    def evaluate(self, x):
        return self.T.evaluate(x) and self.F.evaluate(x)
...
class OrTrigger(Trigger):
    ...
    def evaluate(self, x):
        return self.T.evaluate(x) or self.F.evaluate(x)
...
def filter_stories(stories, triggerlist):
    ...
    for story in stories:
        for trigger in triggerlist:
            eval1 = trigger.evaluate(story)
            if eval1 == True and story not in newstories:
...
def main_thread(master):
    ...
    try:
        ...
        t2 = DescriptionTrigger("and")
        t3 = DescriptionTrigger("no")
        t4 = AndTrigger(t2, t3)
        triggerlist = [t1, t4]

        # Problem 11
        # TODO: After implementing read_trigger_config, uncomment this line 
        triggerlist = read_trigger_config('/mnt/c/Users/Vlad/Documents/GitHub/someproj/py problemset 5/triggers.txt')
